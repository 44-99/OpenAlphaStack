...
Usage:
  openalphastack tools daily_report <run_id>                    # latest day
  openalphastack tools daily_report <run_id> --date 2024-03-15  # specific day
  openalphastack tools daily_report <run_id> --all              # all days
  openalphastack tools daily_report <run_id> --push             # push to Feishu
"""
import argparse
import json
import os
...
def _push_to_feishu(report: dict) -> None:
    ...
    try:
        from openalphastack.feishu.bot import send_text
        from openalphastack.config import ALERT_CHAT_IDS
    except ImportError:
    ...
    msg = (
        f"[OpenAlphaStack 交易日報] {report['title']}\n"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="OpenAlphaStack Daily Report Generator")
