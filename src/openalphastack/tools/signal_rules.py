...
import pandas as pd
from openalphastack.tools._fallback import get_hist, get_quote
...
def main():
    ...
    if "-h" in sys.argv or "--help" in sys.argv:
        ...
        print("Usage: openalphastack tools signal_rules CODE [--rule RULE] [--watchlist CODES] [--dragon-head] [--list]")
