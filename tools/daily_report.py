...
Usage:
  python tools/daily_report.py <run_id>                    # latest day
  python tools/daily_report.py <run_id> --date 2024-03-15  # specific day
  python tools/daily_report.py <run_id> --all              # all days
  python tools/daily_report.py <run_id> --push             # push to Feishu
"""
import argparse
import json
import os
