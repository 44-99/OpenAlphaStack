...
Runs in the paper_engine fast lane. Each rule returns dict or None.
Importable by paper_engine.py, also usable as standalone CLI.
"""
import argparse
import json
import os
...
def main():
    ...
    if "-h" in sys.argv or "--help" in sys.argv:
        ...
        print("Usage: python tools/signal_rules.py CODE [--rule RULE] [--watchlist CODES] [--dragon-head] [--list]")
